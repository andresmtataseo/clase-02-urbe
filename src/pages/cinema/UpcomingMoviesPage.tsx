...
const UpcomingMoviesPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchUpcoming = async () => {
            ...
            const url = `${import.meta.env.VITE_URL_TMDB}/movie/upcoming?language=es-MX&page=1&region=MX`;
            ...
            if ( !response.ok) {
                setError(true)
                throw new Error("No se ha podido consultar las películas próximamente");
            }
    ...
    <div className="flex-1">
        ...
        <div className="p-8">
        <h1 className="text-4xl font-bold mb-2">Próximamente</h1>
        <p className="  ">Descubre las películas que pronto llegarán a los cines</p>
        </div>
